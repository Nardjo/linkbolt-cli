...
import { retrieveResource } from "./resources/retrieve.js";
...
program
  .name("linkbolt-cli")
  .description(
    "CLI for the Linkbolt machine API (Capture / search / retrieve / Resource). Docs: docs/agents/machine-api.md",
  )
  .version("0.1.0")
...
program.addCommand(retrieveResource);
